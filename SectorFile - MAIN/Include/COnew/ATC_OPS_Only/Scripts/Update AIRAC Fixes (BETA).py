...
# Define a dictionary with the list of ICAOs for each output file and their respective subfolder paths
icao_dict = {
    ...
    "BOG_TERM.fix": {"ICAOs":{"SKBO","SKPQ","SKTI","SKQU","SKIB","SKGY","SKGI","SKMA","SKME"}, "subfolder": r"\Aurora\SectorFiles\Include\COnew\TMA\BOG\NAVAIDS",},
    ...
    "MIL_TERM.fix": {"ICAOs":{"SKPQ"}, "subfolder": r"\Aurora\SectorFiles\Include\COnew\FIR\MIL\NAVAIDS",},
    ...
    # Add more output files and corresponding ICAOs with their subfolder paths
}
...
if not os.path.exists(input_file):
    ...
    with open(input_file, "r") as file:
        for line in file:
            ...
            # Extract the 4th variable, normalize, and convert to integer
            ...
            if parameter == 1 and "//" in notes:
                icao_code = notes.split("//")[-1].strip()  # Extract ICAO code from comment
